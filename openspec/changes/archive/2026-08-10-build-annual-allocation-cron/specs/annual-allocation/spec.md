...
The service SHALL grant an annual subscription its plan's monthly credits once per elapsed month,
to subscriptions that are `ACTIVE`, or `CANCELED` while still inside `paidThroughAt`.
